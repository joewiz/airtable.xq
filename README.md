...
conventions style. XDM terminology replaces JSON terminology, and parameters 
...
1.  Download the `airtable.xq-2.0.0.xar` file from GitHub [releases](https://github.com/joewiz/airtable.xq/releases) page.
